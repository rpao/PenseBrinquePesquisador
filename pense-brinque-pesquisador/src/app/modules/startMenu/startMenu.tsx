...
import DashboardPage from '../dashboards/dashboardsPage';
import { getDashboards } from '@/app/utils';
import ReportExtractionPage from '../reportExtraction/reportExtractionPage';
...
export default function StartMenu(props: StartMenuProps) {
  const dashboardPageData = getDashboards();
  ...
  return (
    <div className='main-container start-menu-container'>
